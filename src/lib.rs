...
mod tests {
    ...
    use super::{add_brick, get, put, shutdown};

    // This test will fail with "pure virtual function called" if `--release` flag is NOT given.
    ...
    fn test_put_get() {
        ...
        put(brick_id, b"key1", b"val1".to_vec()).unwrap();
        put(brick_id, b"key2", b"val2".to_vec()).unwrap();
